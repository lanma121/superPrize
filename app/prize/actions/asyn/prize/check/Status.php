...
class Action_CheckStatus extends App_Action{
	...
	public function __execute(){
		...
		if(!empty($data) && intval($data['pid'])>0){
			...
			return array(
				'result'	=> intval($prizeInfo['prize_status']),
				'factnm'	=> intval($prizeInfo['prize_fact_num']),
				'caleor'	=> intval($prizeInfo['prize_min_num']-$prizeInfo['prize_fact_num'])
			);
		}
